...
Flight::route('GET /api/employees/@employee_id', function ($employee_id) {
...
Flight::route("PUT api/employees/@employee_id", function($employee_id){
    $data = Flight::request()->data->getData();
...
Flight::route('DELETE /api/employees/@employee_id', function ($employee_id) {
